...
All you need to run the scripts is to have Python on your system. If
it is not already installed, you can download the latest version at
http://www.python.org/download/. Then unzip the archive in a directory
of your choice.
...
bugs/errors, please let me know by email: roberto.sommariva@noaa.gov
